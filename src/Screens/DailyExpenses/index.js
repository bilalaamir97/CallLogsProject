...
var url='http://demo.remscloudonline.com/sm_builders/rems_app_baj_services/view_expenses?project='+selectedLanguage+'&from_date='+
date+'&to_date='+dateF
...
<Picker.Item  label="Project" value="0" />
...
<View style={{alignItems:'center'}}>
<Text style={{fontFamily:'calibri',fontSize:25,color:"white"}}> Daily Expenses </Text>
</View>
